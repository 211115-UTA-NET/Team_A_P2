...
namespace PhoenixTheatreApiTests
{
    public class UnitTest1
    {
        ...
        public void GetEmployeeByNameTest()
        {
            ...
            Assert.Equal(employee.Username, actual.Username);
            Assert.Equal(employee.UserPassword, actual.UserPassword);
            Assert.Equal(employee.IsManager, actual.IsManager);
            Assert.Equal(employee.TheatreId, actual.TheatreId);
        }
    }
}